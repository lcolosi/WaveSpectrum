...
set(gca,'TickLabelInterpreter','latex')
pc.EdgeColor = 'none';
annotation('rectangle',[0.172916666666667,0.109296229078443,0.015277777777778,0.34136546184739],...
           'LineStyle','none','FaceColor',blue,'FaceAlpha',0.3);
annotation('rectangle',[0.189657407407406,0.108433734939759,0.011037037037039,0.342704149933063],...
